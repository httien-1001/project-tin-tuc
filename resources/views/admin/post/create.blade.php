                ...
                <div class="col-md-6 ">
                    ...
                    <div class="portlet light bordered">
                        ...
                        <div class="portlet-body form">
                            <form role="form"  method="POST" action="{{route('admin.post.store')}}" enctype="multipart/form-data" runat="server">
                                @csrf
                                ...
                                <div class="form-body">
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-icon">
                                                <i class="fa font-green"></i>
                                                <input type="file" class="form-control" name="profile_image" value="{{old('profile_image')}}" id="imgInp">
                                                @error('profile_image')
                                                <div class="alert alert-danger alert-dismissible" role="alert">
                                                    {{$message }}
                                                </div>
